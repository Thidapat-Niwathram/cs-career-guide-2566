...
@section('pagetitle')
    <h4 class="page-title pull-left">Edit Career Of Soft Skill</h4>
@endsection
@section('content')
    <style>
        .form-control{
    ...
    <table id="courseTable" class="container p-2 table table-bordered border-primary table-light">
        ...
        <tr  class="align-items-center">
            <td><input type="text" name="subject" class="form-control" placeholder="Input career"></td>
            <td>
                <div class="col-sm-10">
    ...
    <div class="d-flex justify-content-between">
        <button class="btn btn-primary" type="button" onclick="window.location.href='{{ url('editsoftskcourse') }}'">Back</button>
        <div></div>
        <button class="btn btn-primary" type="button" onclick="window.location.href='{{ url('mnsoftskill') }}'">Edit</button>
    </div>
