...
@section('pagetitle')
    <h4 class="page-title pull-left">Add Course</h4>
@endsection
@section('content')
    <style>
    ...
    <div class="container d-flex align-items-center justify-content-center">
        <form class="container-fluid" action="/">
            <div class="row mb-3">
                <label for="careertype" class="col-sm-2 col-form-label">Course ID</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="coursenameen"  name="coursenameen">
                </div>
            </div>
    ...
    <div class="d-flex justify-content-between">
        ...
        <div></div>
        <button class="btn btn-primary" type="button" onclick="window.location.href='{{ url('courseaddsoftsk') }}'">Next</button>
