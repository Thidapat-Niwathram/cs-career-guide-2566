...
@section('pagetitle')
    <h4 class="page-title pull-left">Input your grade</h4>
@endsection
@section('content')
    <style>
        .form-control{
    ...
    <div class="d-flex justify-content-between">
        <button class="btn btn-primary" type="button" onclick="window.location.href='{{ url('slcareer') }}'">Back</button>
        <div></div>
        <button class="btn btn-primary" type="button" onclick="window.location.href='{{ url('courseguide') }}'">Next</button>
    </div>
